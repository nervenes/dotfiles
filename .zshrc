...
export FZF_DEFAULT_OPTS="--layout=reverse --color=bg+:#37383d,bg:#292a2f,border:#5c5f66,spinner:#4db0cc,hl:#b281ea,fg:#ffffff,header:#b281ea,info:#78c2b3,pointer:#ff79b2,marker:#ff79b2,fg+:#ffffff,prompt:#d9c97c,hl+:#ff8170"
